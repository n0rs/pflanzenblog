<header class="kopfzeile">
    <div class="logo-bereich">
        ...
        <?php if ($sicherheitsstufe >= 1): ?>
            <div class="benutzer-status">
              <img src="<?php echo e(assetPath('icons/account.svg')); ?>" alt="Account" class="icon stay" title="<?php echo e($_SESSION['benutzername']); ?>">
    ...
    <nav>
        <a href="index.php">
            <img src="<?php echo e(assetPath('icons/house.svg')); ?>" alt="Home" class="kopfzeilen-icon" title="Übersicht">
            <span class="kopfzeilen-text" title="Übersicht">Übersicht</span>
        </a>
        <?php if ($sicherheitsstufe >= 1): ?>
            <a href="beitrag_erstellen.php">
                <img src="<?php echo e(assetPath('icons/new.svg')); ?>" alt="Neuer Beitrag" class="kopfzeilen-icon" title="Neuer Beitrag">
        ...
        <form action="suchergebnisse.php" method="get" class="header-search-form">
            ...
            <button type="submit" class="search-icon-button">
                <img src="<?php echo e(assetPath('icons/search.svg')); ?>" alt="Suchen" class="icon stay">
            </button>
        </form>
        ...
        <?php if ($sicherheitsstufe == 0): ?>
            <a href="registrieren.php">
                <img src="<?php echo e(assetPath('icons/registrieren.svg')); ?>" alt="Registrieren" class="kopfzeilen-icon" title="Registrieren">
                <span class="kopfzeilen-text" title="Registrieren">Registrieren</span>
            </a>
        <?php endif; ?>
        <a href="<?php echo ($sicherheitsstufe >= 1) ? 'logout.php' : 'login.php'; ?>">
            <img src="<?php echo e(assetPath('icons/' . (($sicherheitsstufe >= 1) ? 'logout.svg' : 'login.svg'))); ?>"
        ...
        <a href="ueber_uns.php">
            <img src="<?php echo e(assetPath('icons/question.svg')); ?>" alt="Ueber uns" class="kopfzeilen-icon" title="Über uns">
